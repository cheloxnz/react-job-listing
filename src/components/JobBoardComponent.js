...
const JobBoardComponent = ({ job: {
    ...
    return (
        ...
        rounded ${featured && 'border-l-4 border-teal-500 border-solid'
            ...
            <div>
                <img className='-mt-16 mb-4 w-20 h-20 sm:w-25 sm:h-25 sm:my-0' src={logo} alt={company} />
            </div>
            <div className='flex flex-col justify-between ml-4'>
                <h3 className='font-bold text-teal-500'>
                    ...
                    {isNew && (
                        <span className='bg-gray-800 font-bold py-1 px-2 rounded-full uppercase text-sm'>
                            Featured
                        </span>
                    )}
                </h3>
